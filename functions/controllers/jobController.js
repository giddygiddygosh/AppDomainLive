...
const fs = require('fs');
const os = require('os'); // <--- ADDED: Required for temporary directory
const Job = require('../models/Job');
const Customer = require('../models/Customer');
const StockItem = require('../models/StockItem');
const CompanySetting = require('../models/CompanySetting');
const sendTemplatedEmail = require('../utils/emailTriggerService');
const Form =require('../models/form'); // Corrected from 'form' to 'forms'
...
// ✅ CORRECTED: Use the writable temporary directory for uploads
