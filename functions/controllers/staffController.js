...
// NEW FUNCTION: Get a simplified list of staff for dropdowns
/**
 * @desc    Get a simplified list of staff members (e.g., for dropdowns)
...
const getStaffList = asyncHandler(async (req, res) => {
    ...
    const staffList = await Staff.find({ company: companyId }, 'contactPersonName _id').lean(); 
...
module.exports = {
    ...
    sendRouteToStaff,
    getStaffStats,
    getStaffList, // ⭐ **THIS IS THE KEY CHANGE: Export the new function!**
};